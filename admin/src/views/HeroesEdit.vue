            ...
            <el-tabs value="basic" type="border-card">
                <el-tab-pane label="基本信息" name="basic">
                    ...
                    <el-form-item label="使用技巧">
                        <el-input type="textrea" v-model="model.usageTips"></el-input>
                    </el-form-item>
                    <el-form-item label="对抗技巧">
                        <el-input type="textrea" v-model="model.battleTips"></el-input>
                    </el-form-item>
                    <el-form-item label="团战思路">
                        <el-input type="textrea" v-model="model.teamTips"></el-input>
                    </el-form-item>
                </el-tab-pane>
...
export default {
    ...
    methods:{
        async save(){
            ...
            if(this.id){
                res = await this.$http.put('/api/rest/heroes/'+this.id,this.model);
            }else{
        ...
        async fetch(){
            const res = await this.$http.get('/api/rest/heroes/'+this.id);
