...
export default {
    ...
    methods:{
        async save(){
            ...
            if(this.id){
                res = await this.$http.put('/api/rest/ads/'+this.id,this.model);
            }else{
                res = await this.$http.post('/api/rest/ads',this.model);
            }
        ...
        async fetch(){
            const res = await this.$http.get('/api/rest/ads/'+this.id);
